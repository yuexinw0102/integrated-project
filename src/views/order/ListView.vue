            ...
            <el-card shadow="never">
              ...
              >
                ...
                <el-table-column prop="orderPay" label="支付方式" width="110">
                  <template v-slot="scope">
                    <el-tag type="danger" v-if="scope.row.payStatus === '0'">
                      未支付
                    </el-tag>
                    <el-tag v-else-if="scope.row.payStatus === '1'">
                      微信
                    </el-tag>
                    <el-tag v-else-if="scope.row.payStatus === '2'">
                      支付宝
                    </el-tag>
                ...
                <el-table-column prop="payStatus" label="订单状态" width="110">
                  <template slot-scope="scope">
                    ...
                    <el-tag v-else-if="scope.row.payStatus === '3'"
                      >配送中
                    </el-tag>
                    <el-tag
                      type="success"
                    ...
                    <el-tag type="info" v-else> 交易关闭 </el-tag>
                  </template>
                </el-table-column>
